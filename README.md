...
**Self validated?** [![Build Status](https://travis-ci.org/self-validating-blueprint/travis-ci-python.svg?branch=master)](https://travis-ci.org/self-validating-blueprint/travis-ci-python) runs weekly with [http://traviscron.pythonanywhere.com](traviscron)
